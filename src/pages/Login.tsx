    ...
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-8 animate-fade-in">
        <div className="flex flex-col items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-foreground">Connexion à RestoManager</h1>
          <p className="text-sm text-muted-foreground">Gérez votre restaurant en toute simplicité</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl border border-border bg-card p-8 shadow-elevated space-y-5">
          ...
          <Button type="submit" className="w-full gradient-accent text-accent-foreground font-semibold shadow-elevated">Se connecter</Button>
